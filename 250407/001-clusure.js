...
const handleClick = (name) => {
    console.log(`${name} 버튼이 클릭되었습니다다`);
};
const throttleClick = throttle(handleClick, 2000);throttleClick("버튼 1"); //arg ['버튼1']
throttleClick("버튼 1", "버튼2");//arg ['버튼1', '버튼2']
throttleClick();
...
const handleInput = (input) => {
    console.log(`입력 값 ${input}이 발생했습니다`);
};
