...
// 객체 타입 -> 참조값(실제 객체가 저장되어 있는 메모리 주소)
console.log({} ==={}); //false
const obj1={name:" 위니브"};
const obj2={name:'위니브'};
console.log(obj1===obj2); //false
const obj3= obj1;
console.log(obj1===obj3); // 같은 메모리 참조true
...
console.log('myMap length:', myMap.size.length);
...
// 3. 성능
// - 대량의 데이터를 수정하거나 삭제  -> Map 성능이 좋다 (pc 설정? 마다 다름)